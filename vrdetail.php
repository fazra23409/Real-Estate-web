...
<body>
    ...
    <main>
        ...
        <section class="details">
            ...
            <h3>FEATURES:</h3>
            <ul>
                <li><strong>Judul:</strong> Villa Rental </li>
                <li><strong>Bangunan:</strong> Kamar, dan Sarapan</li>
                <li><strong>Lantai:</strong> 1</li>
                <li><strong>Kamar:</strong> 2</li>
                <li><strong>Kamar Mandi:</strong> 2</li>
                <li><strong>Kolam renang:</strong> Kolam renang sharing</li>
                <li><strong>Sumber air:</strong> Baik</li>
                <li><strong>Layanan handphone:</strong> Tidak ada</li>
                <li><strong>Internet:</strong> Fiber Optic</li>
                <li><strong>Listrik:</strong> 7,000 watt</li>
                <li><strong>Furnitur:</strong> Fully Furnsihed</li>
                <li><strong>Luas lahan:</strong> 1600 km</li>
                <li><strong>Luas Gedung:</strong> 1600 sqm</li>
                <li><strong>Lease Period:</strong> 03/12/2013 - 08/02/2038 (Extendable: Yes)</li>
            </ul>
        </section>

        <section class="description">
            <h3>Villa di Jakarta yang mewah tapi masih ramah di kantong</h3>
    ...
    <script>
        window.onload = function() {
            var swiper = new Swiper(".mySwiper", { 
                // my swipper masuknya ke tag myswipper html baru dijadiin slider
                loop: true,
                // loop berulang jd slider akan berputar trs deh
                spaceBetween: 10,
                navigation: {
                ...
                pagination: {
                    ...
                    // elemen html pagination akan ditampilkan
                    clickable: true,
                },
            });
        };
